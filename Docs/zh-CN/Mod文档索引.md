...
2. 要配 Mod 元数据与 `ModInfo.json`：看 [ModInfo字段说明.md](./ModInfo字段说明.md)。  
3. 要配 **GameplayTag / Mod 专用 ini**：看 [ModGameplayTags标签配置.md](./ModGameplayTags标签配置.md)。  
4. 要写 Mod **Lua 入口与附加脚本**：看 [ModLua脚本说明.md](./ModLua脚本说明.md)。  
