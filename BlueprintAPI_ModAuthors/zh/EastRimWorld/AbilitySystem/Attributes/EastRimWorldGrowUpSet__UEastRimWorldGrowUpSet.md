# `class` `UEastRimWorldGrowUpSet`

**源码头文件:** `EastRimWorld/AbilitySystem/Attributes/EastRimWorldGrowUpSet.h`

---

## 功能说明（来自头文件注释）

> DECLARE_MULTICAST_DELEGATE_TwoParams(FOnAddMartialArtsExperience,const FGameplayAttribute &Attribute,float /*AddValue);

## 蓝图暴露变量

### 属性 `GlobalExperienceBonus`

| 项目 | 内容 |
|------|------|
| C++ 类型 | `FGameplayAttributeData` |
| 反射说明符 | BlueprintReadOnly, AllowPrivateAccess, Category="EastRimWorld|GrowUp" |
| 蓝图侧含义 | 蓝图 **只读**，不可直接赋值。 |
...
### 属性 `ConstructionExperienceBonus`
...
### 属性 `SocialContactExperienceBonus`
...
### 属性 `IntelligenceExperienceBonus`
...
### 属性 `InternalStrengthExperienceBonus`
...
### 属性 `SpearAndHalberdExperienceBonus`
...
### 属性 `FistsAndPalmsExperienceBonus`
...
### 属性 `HammersAndMacesExperienceBonus`
...
### 属性 `HiddenWeaponsExperienceBonus`
