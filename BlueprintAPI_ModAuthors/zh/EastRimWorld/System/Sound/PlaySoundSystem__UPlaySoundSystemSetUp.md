...
> Play Sound System Set Up UObject 类型。
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | TMap<[ESoundChangeEvent](PlaySoundSystem__ESoundChangeEvent.md),FName> |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | TMap<[EERWSeason](../../WorldSystem/WorldStruct__EERWSeason.md),class UAkAudioEvent*> |
| 反射说明符 | BlueprintReadWrite, Category="AkAudioSound" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
