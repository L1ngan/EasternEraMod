...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<EAssemblePartType , TSoftObjectPtr<UStaticMesh>>` |
| 反射说明符 | BlueprintReadWrite, Category="Mesh" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<EEmbeddedWallType , TSoftObjectPtr<UStaticMesh>>` |
| 反射说明符 | BlueprintReadWrite, Category="Wall" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<ERoofPartType , TSoftObjectPtr<UStaticMesh>>` |
| 反射说明符 | BlueprintReadWrite, Category="Mesh" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TArray<EEnergyControlType>` |
| 反射说明符 | BlueprintReadWrite, Category="Energy" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<EGenerateBuildingFaultProbability,float>` |
| 反射说明符 | BlueprintReadWrite, Category="Energy" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<EGenerateBuildingFaultType,int32>` |
| 反射说明符 | BlueprintReadWrite, Category="Energy" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
...
| 项目 | 内容 |
|------|------|
| C++ 类型 | `TMap<EGenerateBuildingFaultType,FAbilityProjectileStruct>` |
| 反射说明符 | BlueprintReadWrite, Category="Energy" |
| 蓝图侧含义 | 蓝图可 **读取与写入**（仍受 Edit 系列说明符在编辑器中的限制）。 |
