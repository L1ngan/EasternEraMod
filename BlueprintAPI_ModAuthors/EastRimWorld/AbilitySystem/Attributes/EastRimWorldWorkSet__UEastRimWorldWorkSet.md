# `class` `UEastRimWorldWorkSet`

**源码头文件：** `EastRimWorld/AbilitySystem/Attributes/EastRimWorldWorkSet.h`
...
### 属性 `GlobalWorkAddition`

| 项目 | 内容 |
|------|------|
| C++ 类型 | `FGameplayAttributeData` |
| 反射说明符 | BlueprintReadOnly, AllowPrivateAccess, Category="EastRimWorld|Work" |
| 蓝图侧含义 | 蓝图 **只读**，不可直接赋值。 |
...
### 属性 `AnimalCollectionSuppliesExtraOutput`
...
### 属性 `AnimalCollectionSuppliesSpeed`
