# `class` `UEastRimWorldSocialSet`

**源码头文件：** `EastRimWorld/AbilitySystem/Attributes/EastRimWorldSocialSet.h`
...
### 属性 `NegotiationAbility`

| 项目 | 内容 |
|------|------|
| C++ 类型 | `FGameplayAttributeData` |
| 反射说明符 | BlueprintReadOnly, AllowPrivateAccess, Category="EastRimWorld|Social" |
| 蓝图侧含义 | 蓝图 **只读**，不可直接赋值。 |
