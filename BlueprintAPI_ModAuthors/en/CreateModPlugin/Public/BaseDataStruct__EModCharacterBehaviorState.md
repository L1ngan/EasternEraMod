# `enum` `EModCharacterBehaviorState`
...
> Enum of mod character behavior states, identifying the action a character is currently performing (combat, sleeping, eating, working, gathering, taming, etc.).
