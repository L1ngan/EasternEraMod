...
| Field | Details |
|------|------|
| C++ type | TMap<[FModGenerationData](GenerationMonster__FModGenerationData.md),int32> |
| Reflection specifiers | BlueprintReadWrite |
| Blueprint semantics | Readable and writable in Blueprint (still subject to Edit* specifiers in the editor). |
| Original declaration (excerpt) | `UPROPERTY(BlueprintReadWrite,EditAnywhere) TMap<FModGenerationData,int32> GenerationData;` |
