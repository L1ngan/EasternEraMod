...
### Property `MaleProtagonistVoiceID`
...
### Property `FemaleProtagonistVoiceID`
...
| Field | Details |
|------|------|
| C++ type | TMap<EItemQuality, [FCharacteristicNumWeight](NewGameStruct__FCharacteristicNumWeight.md)> |
| Reflection specifiers | BlueprintReadWrite |
| Blueprint semantics | Readable and writable in Blueprint (still subject to Edit* specifiers in the editor). |
...
### Property `CanSelectStations`

| Field | Details |
|------|------|
| C++ type | TArray<[FNewGamePlace](NewGameStruct__FNewGamePlace.md)> |
| Reflection specifiers | BlueprintReadWrite |
| Blueprint semantics | Readable and writable in Blueprint (still subject to Edit* specifiers in the editor). |
