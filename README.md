...
| [ModGameplayTags标签配置.md](./ModGameplayTags标签配置.md) | **`IncludeGameplayTags`**、`{ModId}GameplayTags.ini`、Gameplay Tag 管理器 Source、打包分发 |
...
3. 要配置 Mod **GameplayTag / ini**：看 [ModGameplayTags标签配置.md](./ModGameplayTags标签配置.md)。  
4. 要编写 Mod **Lua**：看 [ModLua脚本说明.md](./ModLua脚本说明.md)。  
5. 要做角色/怪物模型：看 [模型导入与骨骼匹配说明.md](./模型导入与骨骼匹配说明.md)。  
6. 要在表里填网格与动画路径：看 [Mod数据表与骨骼网格字段说明.md](./Mod数据表与骨骼网格字段说明.md)，并对照结构体头文件。  
7. 要产出可安装的 Pak：看 [Mod编辑器与打包说明.md](./Mod编辑器与打包说明.md)。  
8. 要在安装版游戏里验证 Mod：看 [Mod测试说明.md](./Mod测试说明.md)。
