...
#define FOREACH_ENUM_EMODCONFIGTYPE(op) \
	...
	op(EModConfigType::DialogueGroup) \
	op(EModConfigType::DialogueInfoConfig) \
	op(EModConfigType::DialogueOptionConfig) \
	op(EModConfigType::WorldTaskInfo) \
	op(EModConfigType::ConditionInfo) \
	...
	op(EModConfigType::MartialArtsBook) \
	op(EModConfigType::MartialArtsBookCategory) \
	op(EModConfigType::RealmData) \
	op(EModConfigType::MartialArtsEntries) \
	op(EModConfigType::BreakThroughSkill) \
	op(EModConfigType::BreakThroughCharacteristicInfo) \
	op(EModConfigType::SkillEntryConfig) \
