...
FClassRegistrationInfo Z_Registration_Info_UClass_AModularAIController;
UClass* AModularAIController::GetPrivateStaticClass()
{
	using TClass = AModularAIController;
	if (!Z_Registration_Info_UClass_AModularAIController.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ModularAIController"),
			Z_Registration_Info_UClass_AModularAIController.InnerSingleton,
			StaticRegisterNativesAModularAIController,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AModularAIController.InnerSingleton;
}
UClass* Z_Construct_UClass_AModularAIController_NoRegister()
{
	return AModularAIController::GetPrivateStaticClass();
}
