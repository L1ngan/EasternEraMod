---An enum that lists Niagara's common numeric data types.
---@class ENiagaraNumericVariableTypes
...
---@field public ENiagaraNumericVariableTypes_MAX integer
local ENiagaraNumericVariableTypes = {}
