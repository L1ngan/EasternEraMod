...
---@field public bIsEngineDefaultProfile boolean @Whether or not this profile is one of the default profiles included with the engine
...
---@field public bShowGrid boolean @Toggle visibility of floor grid on/off
...
---@field public bEnableToneMapping boolean @Useful when editing in an unlit view, prevents colors from being adjusted by the tonemapping
---@field public bShowMeshEdges boolean @Show wireframes composited on top of the shaded view
