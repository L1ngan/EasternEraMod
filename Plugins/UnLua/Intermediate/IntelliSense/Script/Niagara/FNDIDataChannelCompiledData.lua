...
---@field protected bSpawnsParticles boolean
---@field protected bCallsWrite boolean @If we call Write() on our CPU buffers we must do some extra buffer book keeping.
