...
---@field public SpecularScale number @The specular scale to use for all lights if no binding was found
---@field public DiffuseScale number @The diffuse scale to use for all lights if no binding was found
---@field public ColorAdd FVector3f @A static color shift applied to each rendered light
...
---@field public SpecularScaleBinding FNiagaraVariableAttributeBinding @Which attribute should we use for the specular scale when generating lights?
---@field public DiffuseScaleBinding FNiagaraVariableAttributeBinding @Which attribute should we use for the diffuse scale when generating lights?
