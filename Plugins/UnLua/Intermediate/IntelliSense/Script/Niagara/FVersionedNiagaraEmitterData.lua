...
---@field public bDeprecated boolean @If this emitter version is no longer meant to be used, this option should be set.
...
---@field public InterpolatedSpawnMode ENiagaraInterpolatedSpawnMode @This defines if newly spawned particles run only the spawn script on the first frame or both spawn and update with optional parameter interpolation.
