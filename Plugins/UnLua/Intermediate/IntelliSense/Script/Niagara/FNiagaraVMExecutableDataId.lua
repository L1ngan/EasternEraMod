...
---@field public InterpolatedSpawnMode ENiagaraInterpolatedSpawnMode @Do we require interpolated spawning
...
---@field public bDisableDebugSwitches boolean @Whether or not we allow debug switches to be used.
