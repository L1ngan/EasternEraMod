...
---@field public InterpolationMode EChaosCacheInterpolationMode
...
---@field private CacheData TScriptInterface<UChaosCacheData> @Optional cache data to store on the chaos cache
