...
---@field public bIsDepthOfFieldSupported boolean @Set to false to force the camera to disable depth of field
---@field public bIsDynamicFilmbackSupported boolean @Specifies if the live link subject will send dynamic changes to the film back.
