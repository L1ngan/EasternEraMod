...
---@field public AllowedDensityRange FFloatInterval @Specifies the density range where the grass variety is allowed to be spawned ([0,1] represents the entire range).
