...
---@return boolean
function USkeletalMeshEditorSubsystem.StripLODGeometry(SkeletalMesh, LODIndex, TextureMask, Threshold) end

---Set the overlay material for a Skeletal Mesh.
---@param SkeletalMesh USkeletalMesh
---@param NewOverlayMaterial UMaterialInterface
---@return boolean
function USkeletalMeshEditorSubsystem:SetSkeletalMeshOverlayMaterial(SkeletalMesh, NewOverlayMaterial) end
...
---@param OptionalNames TArray_string_
---@param OptionalPaths TArray_string_
function USkeletalMeshEditorSubsystem.SetMorphTargetsToGeneratedByEngineForAllSkeletalMesh(OptionalNames, OptionalPaths) end

---Set morph targets has generated by engine.
---@param TargetMesh USkeletalMesh
---@param OptionalNames TArray_string_
---@return boolean
function USkeletalMeshEditorSubsystem.SetMorphTargetsToGeneratedByEngine(TargetMesh, OptionalNames) end

---Set the overlay material for a material slot in a Skeletal Mesh.
---@param SkeletalMesh USkeletalMesh
---@param SlotIndex integer
---@param NewSectionOverlayMaterial UMaterialInterface
---@return boolean
function USkeletalMeshEditorSubsystem:SetMaterialSlotOverlayMaterial(SkeletalMesh, SlotIndex, NewSectionOverlayMaterial) end
...
---@return boolean
function USkeletalMeshEditorSubsystem.RemoveLODs(BaseMesh, ToRemoveLODs) end
...
---@param Filter ESkelSubSysQueryCurvesMetatdataNamesFilter
function USkeletalMeshEditorSubsystem.GetSkeletonCurveMetaDataNames(TargetSkeleton, OutNames, Filter) end

---Get the overlay material for a Skeletal Mesh.
---@param SkeletalMesh USkeletalMesh
---@return UMaterialInterface
function USkeletalMeshEditorSubsystem:GetSkeletalMeshOverlayMaterial(SkeletalMesh) end
...
---@param SlotIndex integer
---@return UMaterialInterface
function USkeletalMeshEditorSubsystem:GetMaterialSlotOverlayMaterial(SkeletalMesh, SlotIndex) end
