...
---@field public PlayRate FMovieSceneTimeWarpVariant @The playback rate of the animation clip
...
---@field public MirrorDataTable UMirrorDataTable
...
---@field public bLinearPlaybackWhenScaled boolean
