...
---@field public Density number @Density - 0.0 < 0.85 < 1.0 - Coloration of the late reverb - lower value is more grainy
---@field public Diffusion number @Diffusion - 0.0 < 0.85 < 1.0 - Echo density in the reverberation decay - lower is more grainy
...
---@field public WetLevel number @Overall wet level of the reverb effect
---@field public DryLevel number @Overall dry level of the reverb effect
---@field public bBypass boolean @Bypasses reverb
