...
---@field public Strength FPhysicalMaterialStrength
---@field public DamageModifier FPhysicalMaterialDamageModifier
---@field public DebugColor FLinearColor @Color used to represent this material in certain debug views (e.g. landscape collision)
---@field public bShowExperimentalProperties boolean @Experimental material properties are enabled via the p.PhysicalMaterial.ShowExperimentalProperties console variable.               NOTE: These are _experimental_ properties which may change. Use at your own risk!
---@field public SoftCollisionMode EPhysicalMaterialSoftCollisionMode @For enable soft collision shell thickness mode
---@field public SoftCollisionThickness number @Thickness of the layer just inside the collision shape in which contact is considered "soft".               The units depend on SoftCollisionMode
---@field public BaseFrictionImpulse number @A friction (positional) impulse of at least this magnitude may be applied,               regardless the normal force. This is analogous to adding only the lateral part of a               "stickiness" to a material
