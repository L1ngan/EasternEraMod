...
---@field public bUpdateKinematicFromSimulation boolean @When kinematic, whether the actor transform should be updated as a result of movement in the simulation, rather than immediately whenever a target transform is set.
---@field public bGyroscopicTorqueEnabled boolean @Enabled/disables whether this body is affected by gyroscopic torque, mainly useful for long/thin objects that spin
...
---@field public bUpdateMassWhenScaleChanges boolean @If true, it will update mass when scale change *
