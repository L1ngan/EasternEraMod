...
---@field public NavigationToolState FNavigationToolSaveState @Saved Navigation Tool state to restore
---@field public SoloNodes TArray<string> @Nodes currently marked Solo, stored as node tree paths
---@field public MuteNodes TArray<string> @Nodes currently marked Mute, stored as node tree paths
