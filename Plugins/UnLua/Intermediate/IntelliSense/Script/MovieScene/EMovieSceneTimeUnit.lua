...
---@class EMovieSceneTimeUnit
---@field public DisplayRate integer
---@field public TickResolution integer
---@field public EMovieSceneTimeUnit_MAX integer
local EMovieSceneTimeUnit = {}
