...
---@field public bStickToRecentData boolean
...
---@field public bUseFilterVolumes boolean @Whether to only show events occuring within one of visual logger filter volumes currently in the level
---@field public GraphsBackgroundColor FColor @Background color for 2d graphs visualization
---@field public bPersistentFilters boolean @Whether to store all filter settings on exit
...
---@field protected PersistentFilters FVisualLoggerFiltersData
