...
---@field public PropertyFlags integer @Flags that will get copied over to this property. uint64 since EPropertyFlags is not UEnum
---@field public MetaData TArray<FPropertyBagPropertyDescMetaData> @Editor-only metadata for CachedProperty
