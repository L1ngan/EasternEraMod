...
---@field public LevelSetResolution integer @When creating level sets, the grid resolution to use
---@field public LatticeResolution integer @When creating skinned level sets, the embedding grid resolution to use
