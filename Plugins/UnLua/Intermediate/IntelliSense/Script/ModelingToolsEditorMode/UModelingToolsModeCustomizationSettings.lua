...
---@field public UnselectedColor FLinearColor @Custom color for when geometry is not a part of current selection when using Mesh Element Selection
---@field public HoverOverSelectedColor FLinearColor @Custom color hovering over selected geometry in Mesh Element Selection
---@field public HoverOverUnselectedColor FLinearColor @Custom color hovering over unselected geometry in Mesh Element Selection
---@field public GeometrySelectedColor FLinearColor @Custom color for when geometry is a part of the current selection when using Mesh Element Selection
...
---@field public bMeshSelectionHitBackFaces boolean
