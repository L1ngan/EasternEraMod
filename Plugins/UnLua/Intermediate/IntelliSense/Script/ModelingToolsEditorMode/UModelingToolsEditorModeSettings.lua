...
---@field public bEnablePersistentSelections boolean @UPROPERTY(config, EditAnywhere, Category = "Modeling Mode|Selection", meta = (DisplayName="Enable Mesh Selection UI"))
---@field public bEnableMeshSelections boolean @Enable/Disable the Mesh Selection System.
