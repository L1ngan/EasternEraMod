...
---@field public bDoScaleMipsForAlphaCoverage boolean @Whether mip RGBA should be scaled to preserve the number of pixels with Value >= AlphaCoverageThresholds
---@field public bUseNewMipFilter boolean @Whether to use newer & faster mip generation filter
...
---@field public HDRImportShouldBeLongLatCubeMap integer @Store YesAll/NoAll responses:
