...
---@field public XAxisColor FLinearColor @用于X轴的颜色
---@field public YAxisColor FLinearColor @用于Y轴的颜色
---@field public ZAxisColor FLinearColor @用于Z轴的颜色
...
---@field public bAntiAliasGrid boolean @Whether grid lines should be anti-aliased
...
---@field public bEnableMiddleEllipsis boolean @If true MiddleEllipsis will be used by certain editor widget (ex: Tab Title/Outliner Actor Names), otherwise the default policy will be used instead
