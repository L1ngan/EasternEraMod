...
---@field public bUseClassDefaultObject boolean @Should we get the default object from the specified object before passing it to the renderer?  (only used for blueprints)
