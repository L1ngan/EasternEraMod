...
---@field public bShowBoneColors boolean @If true then the bones are displayed with multiple semi-random colors
...
---@field public bShowBoneIndexes boolean @Whether to append each bone's index to its name when shown in the skeleton tree
