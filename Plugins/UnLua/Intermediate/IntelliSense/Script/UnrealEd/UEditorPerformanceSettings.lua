...
---@field public bEnableEditorPeformanceTool boolean @Whether to enable Editor Perf Tool Completely
---@field public bEnableNotifications boolean @Whether to enable Editor Perf Warnings
---@field public NotificationList TArray<string> @Specific measurements to notify
---@field public bEnableTelemetry boolean @Whether to enable Telemetry
---@field public bEnableSnapshots boolean @Whether to create Insights Snapshots
---@field public bShowWarningsOnly boolean @Whether to Show Warnings Only
---@field public bEnableExperimentalFeatures boolean @Whether to enable Editor Perf Tool Experimental Features
