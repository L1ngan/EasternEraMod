...
---@field private EnumProperty EPropertyEditorTestEditColor
---@field private EnumUnderscores EPropertyEditorTestUnderscores
---@field private MatrixProperty FMatrix
---@field private TransformProperty FTransform
---@field private GigabyteProperty number
...
---@field private TimecodePropertyArray TArray<FTimecode>
...
---@field private StructPropertyArrayWithFormattedTitle TArray<FPropertyEditorTestBasicStruct>
---@field private StructPropertyArrayWithTitleError TArray<FPropertyEditorTestBasicStruct>
---@field private StructPropertyArrayWithFormattedTitleError TArray<FPropertyEditorTestBasicStruct>
---@field private InstancedStructArray TArray<FPropertyEditorTestInstancedStruct>
---@field private ObjectPropertyArrayWithTitle TArray<UPropertyEditorTestInstancedObject>
...
---@field private FloatRange FFloatRange
...
---@field private SoftObjectPath FSoftObjectPath
---@field private PrimaryAssetId FPrimaryAssetId
---@field private PrimaryAssetIdWithoutThumbnail FPrimaryAssetId
...
---@field private LightOrStaticMeshActorReference FSoftObjectPath @NOTE: intentionally misplaced space in AllowedClasses
...
---@field private ComponentReference FComponentReference
...
---@field private MaterialNoThumbnail UMaterialInterface
...
---@field private EditColorSet TSet<EPropertyEditorTestEditColor>
---@field private NameSet TSet<string>
---@field private Int32ToStringMap TMap<integer, string>
---@field private StringToMultilineTextMap TMap<string, string>
...
---@field private EnumEditCondition EPropertyEditorTestEditColor
...
---@field private bEditConditionForDirectoryPath boolean
---@field private DirectoryPath FDirectoryPath
...
---@field private AlwaysDisabled integer
---@field private bCategoryInlineEditCondition boolean
---@field private EnabledWhenCategoryChecked number
...
---@field private Timespan FTimespan
---@field private Guid FGuid
---@field private PerPlatformFloat FPerPlatformFloat
---@field private PerPlatformInt FPerPlatformInt
...
---@field private StructWithInlineCondition FPropertyEditorTestEditCondition
---@field private ArrayOfStructsWithInlineCondition TArray<FPropertyEditorTestEditCondition>
---@field private NestedArrayOfInts integer
