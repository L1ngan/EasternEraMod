...
---@field public bDisplayExcludedCollections boolean @Displays collections in the Collections window that were excluded by project settings
...
---@field private AlwaysExpandTooltips boolean @Whether to display the full tooltip on Asset and Folder or the small version with the Ctrl + Alt
