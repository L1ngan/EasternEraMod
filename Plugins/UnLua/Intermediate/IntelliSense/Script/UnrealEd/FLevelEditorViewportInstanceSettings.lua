...
---@field public NaniteVisualizationMode string @The Nanite visualization mode for the viewport.
---@field public LumenVisualizationMode string @The Lumen visualization mode for the viewport.
---@field public SubstrateVisualizationMode string @The Substrate visualization mode for the viewport.
---@field public GroomVisualizationMode string @The Groom visualization mode for the viewport.
---@field public VirtualShadowMapVisualizationMode string @The virtual shadow map visualization mode for the viewport.
---@field public VirtualTextureVisualizationMode string @The virtual texture visualization mode for the viewport.
---@field public RayTracingDebugVisualizationMode string @The buffer visualization mode for the viewport.
---@field public GPUSkinCacheVisualizationMode string @The GPU Skin Cache visualization mode for the viewport.
...
---@field public bAllowCinematicControl boolean @Whether or not this viewport is allowed to be possessed by cinematic/scrubbing tools.
