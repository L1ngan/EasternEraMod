---@class FCacheRecorderUserParameters
...
---@field public bResetPlayhead boolean @Reset playhead to beginning of the playback range when starting recording
---@field public bStopAtPlaybackEnd boolean @Automatically stop recording when reaching the end of the playback range
local FCacheRecorderUserParameters = {}
