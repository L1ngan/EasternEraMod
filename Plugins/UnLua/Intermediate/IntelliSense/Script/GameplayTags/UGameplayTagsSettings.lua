...
---@field public ClearInvalidTags boolean
---@field public AllowEditorTagUnloading boolean @If true, will allow unloading of tags in the editor when plugins are removed
---@field public AllowGameTagUnloading boolean @If true, will allow unloading of tags in a non-editor gebuild when plugins are removed, this is potentially unsafe and affects requests to unload during play in editor
...
---@field public bDynamicReplication boolean @If true, will replicate gameplay tags dynamically by index per connection. Slightly higher cost than FastReplication, but tags can differ between client and server
...
---@field public NewTagSource string @Add a new gameplay tag config file for saving plugin or game-specific tags.
---@field public CleanupUnusedTags string @Find and remove unused tags
