...
---@field public OSVersion string @Holds the device OS Version.
---@field public Architecture string @Holds the device architecture.
---@field public ConnectionType string @Holds the connection type.
