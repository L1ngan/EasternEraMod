...
---@field public ProfileId FGameplayTag
---@field public ProfileIdString string @The Key Mapping Profile identifier that this mapping should be set on. If this is empty, then the currently equipped profile will be used.
