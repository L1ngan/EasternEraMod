...
---@field protected AssociatedInputAction UInputAction
---@field protected AssociatedInputActionSoft TSoftObjectPtr<UInputAction> @The input action associated with this player key mapping
