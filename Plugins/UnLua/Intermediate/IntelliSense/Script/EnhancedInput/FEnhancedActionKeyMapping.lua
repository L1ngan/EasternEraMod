...
---@field public bHasAlwaysTickTrigger boolean @True if any triggers on this mapping or its associated UInputAction are flagged as "always tick" triggers. This is only set when control mappings are rebuilt.
