...
---@field public BLEND_TranslucentColoredTransmittance integer
---@field public BLEND_MAX integer
---@field public BLEND_TranslucentGreyTransmittance integer
---@field public BLEND_ColoredTransmittanceOnly integer
local EBlendMode = {}
