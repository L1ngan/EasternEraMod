...
---@field public SpecificLOD integer @A given LOD level to export from the source meshes, used if LOD Selection Type is set to SpecificLOD
...
---@field public bMergeMeshSockets boolean @Whether to merge sockets
---@field public bMergeMaterials boolean @Whether to merge source materials into one flat material, ONLY available when LOD Selection Type is set to LowestDetailLOD
