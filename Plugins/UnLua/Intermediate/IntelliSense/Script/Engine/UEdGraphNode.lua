...
---@field private bIsIntermediateNode boolean @Whether the node was created as part of an expansion step
---@field public bHasCompilerMessage boolean @Flag to check for compile error/warning
---@field public bCommentBubblePinned boolean @Comment bubble pinned state
