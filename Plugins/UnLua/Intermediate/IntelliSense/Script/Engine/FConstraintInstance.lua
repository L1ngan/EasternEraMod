...
---@field public SecAxis1 FVector @Secondary axis in Body1 reference frame. Orthogonal to PriAxis1.
...
---@field public SecAxis2 FVector @Secondary axis in Body2 reference frame. Orthogonal to PriAxis2.
