...
---@field protected LevelStreamingAddPrimitiveGranularity integer @Batching granularity used to add primitives to scene in parallel when registering actor components during level streaming.
