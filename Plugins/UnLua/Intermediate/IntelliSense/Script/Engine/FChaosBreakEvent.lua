...
---@field public Location FVector @World location of the breaking piece
---@field public Orientation FQuat @World orientation of the breaking piece
...
---@field public Extents FVector @Extents of the bounding box in local space of the breaking piece
