...
---@field public SupportedAgents FNavAgentSelector @restrict link only to specified agents
...
---@field public bSnapToCheapestArea boolean @If set, link will try to snap to the cheapest area in given radius
