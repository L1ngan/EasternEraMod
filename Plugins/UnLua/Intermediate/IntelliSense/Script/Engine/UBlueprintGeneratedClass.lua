...
---@field public bSupportsDynamicInstancedReference boolean @*** Experimental **** This will enable dynamic subobject instancing, which will use default data to determine which properties need instancing at construction/serialization time rather than reflected property 'Instanced' semantics.
...
---@field public FieldNotifies TArray<FFieldNotificationId> @The name of the properties with FieldNotify
...
---@field public CookedPropertyGuids TMap<string, FGuid> @Property guid map (if any), for use only when this BP is cooked
