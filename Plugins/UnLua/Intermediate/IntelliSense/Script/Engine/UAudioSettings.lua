...
---@field public DefaultOcclusionCheckInterval FPerPlatformFloat @The default interval at which to re-test occlusion (in seconds).  Values < 0.f will only check occlusion once.   NOTE! Will be overridden by sounds coming from an audio component!
