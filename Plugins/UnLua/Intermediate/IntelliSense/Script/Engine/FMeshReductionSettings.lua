...
---@field public PercentTriangles number @Percentage of triangles to keep. 1.0 = no reduction, 0.0 = no triangles. (Triangles criterion properties)
---@field public MaxNumOfTriangles integer @The maximum number of triangles to retain when using percentage termination criterion. (Triangles criterion properties)
---@field public PercentVertices number @Percentage of vertices to keep. 1.0 = no reduction, 0.0 = no vertices. (Vertices criterion properties)
---@field public MaxNumOfVerts integer @The maximum number of vertices to retain when using percentage termination criterion. (Vertices criterion properties)
