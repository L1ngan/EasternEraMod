...
---@field public Displacement FExpressionInput @Input for World Height to output to virtual texture.
---@field public Mask4 FExpressionInput @Input for Mask to output to virtual texture.
