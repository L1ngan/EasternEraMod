...
---@field public StaticMeshDescriptionBulkData UStaticMeshDescriptionBulkData @Bulk data containing mesh description. New assets store their source data here instead of in the RawMeshBulkData. If the bulk data within is empty, the LOD is autogenerated (for LOD1+).
...
---@field public CacheMeshDescriptionTrianglesCount integer
---@field public CacheMeshDescriptionVerticesCount integer
