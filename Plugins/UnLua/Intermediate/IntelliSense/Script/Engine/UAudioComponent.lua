...
---@field public DefaultParameters TArray<FAudioParameter> @Array of parameters for this AudioComponent. Changes to this array directly will not be forwarded to the sound if the component is actively playing, and will be superseded by parameters set via the actor interface if set, or the instance parameters.
---@field public InstanceParameters TArray<FAudioParameter> @Array of transient parameters for this AudioComponent instance. Not serialized and can be set by code or BP. Changes to this array directly will not be forwarded to the sound if the component is actively playing. This should be done via the 'SetParameterX' calls implemented by the ISoundParameterControllerInterface. Instance parameter values superseded the parameters set by the actor interface & the component's default parameters.
---@field public SoundClassOverride USoundClass @SoundClass that overrides that set on the referenced SoundBase when component is played.
...
---@field public bEnableHighPassFilter boolean @Whether or not to apply a low-pass filter to the sound that plays in this audio component.
---@field public bOverridePriority boolean @Whether or not to override the priority of the given sound with the value provided.
---@field public bSuppressSubtitles boolean @If true, subtitles in the sound data will be ignored.
---@field public bCanPlayMultipleInstances boolean @If true, the Audio Component will play multiple sound instances at once. Switching sounds or calling play while already playing will not stop already active instances. Virtualization for all played sounds will be disabled. Disabling while sound(s) are playing will not take effect until the AudioComponent is stopped and restarted.
---@field public bDisableParameterUpdatesWhilePlaying boolean @If true, the Audio Component will ignore parameter updates for already-playing sound(s).
...
---@field public EnvelopeFollowerAttackTime integer @The attack time in milliseconds for the envelope follower. Delegate callbacks can be registered to get the envelope value of sounds played with this audio component.
---@field public EnvelopeFollowerReleaseTime integer @The release time in milliseconds for the envelope follower. Delegate callbacks can be registered to get the envelope value of sounds played with this audio component.
---@field public Priority number @If enabled, overrides the priority of the selected sound with the value provided.
...
---@field public LowPassFilterFrequency number @If enabled, the frequency of the Lowpass Filter (in Hz) to apply to this voice. A frequency of 0.0 is the device sample rate and will bypass the filter.
---@field public HighPassFilterFrequency number @If enabled, the frequency of the Highpass Filter (in Hz) to apply to this voice. A frequency of 0.0 is the device sample rate and will bypass the filter.
...
---@field public OcclusionCheckInterval number @The interval at which to re-test occlusion (in seconds).  Values < 0.f will only check occlusion once when we start playback
...
function UAudioComponent:SetOverrideAttenuation(bInOverrideAttenuation) end
...
---@param InHighPassFilterFrequency number
function UAudioComponent:SetHighPassFilterFrequency(InHighPassFilterFrequency) end
...
---sound instance.
---@param InHighPassFilterEnabled boolean
function UAudioComponent:SetHighPassFilterEnabled(InHighPassFilterEnabled) end
...
function UAudioComponent:SetAttenuationSettings(InAttenuationSettings) end

---@param InAttenuationOverrides FSoundAttenuationSettings
function UAudioComponent:SetAttenuationOverrides(InAttenuationOverrides) end
...
---@param Modulators TSet_USoundModulatorBase_
---@param Destination EModulationDestination
function UAudioComponent:RemoveModulationRouting(Modulators, Destination) end
...
---@param Modulators TSet_USoundModulatorBase_
---@param Destination EModulationDestination
function UAudioComponent:AddModulationRouting(Modulators, Destination) end

---Checks whether or not an instance of the provided AssetUserData class is contained.
---@param InUserDataClass TSubclassOf_UAssetUserData_
---@return boolean
function UAudioComponent:HasAssetUserDataOfClass(InUserDataClass) end

---Returns an instance of the provided AssetUserData class if it's contained in the target asset.
---@param InUserDataClass TSubclassOf_UAssetUserData_
---@return UAssetUserData
function UAudioComponent:GetAssetUserDataOfClass(InUserDataClass) end

---Creates and adds an instance of the provided AssetUserData class to the target asset.
---@param InUserDataClass TSubclassOf_UAssetUserData_
---@return boolean
function UAudioComponent:AddAssetUserDataOfClass(InUserDataClass) end
