...
---@field public VMI_VisualizeNanite integer
---@field public VMI_VisualizeVirtualTexture integer
---@field public VMI_VisualizeLumen integer
---@field public VMI_VisualizeVirtualShadowMap integer
---@field public VMI_VisualizeGPUSkinCache integer
---@field public VMI_VisualizeSubstrate integer
---@field public VMI_VisualizeGroom integer
---@field public VMI_LWCComplexity integer
---@field public VMI_Lit_Wireframe integer
---@field public VMI_VisualizeActorColoration integer
