...
---@field public bEnableSourceDataOverride boolean @Enables overriding WaveInstance data using source data override plugin
...
---@field public AudioLinkSettingsOverride UAudioLinkSettingsAbstract @AudioLink Setting Overrides
...
---@field public NonSpatializedRadiusStart number @The distance below which a sound begins to linearly interpolate towards being non-spatialized (2D). See "Non Spatialized Radius End" to define the end of the interpolation and the "Non Spatialized Radius Mode" for the mode of the interpolation. Note: this does not apply when using a 3rd party binaural plugin (audio will remain spatialized).
---@field public NonSpatializedRadiusEnd number @The distance below which a sound is fully non-spatialized (2D). See "Non Spatialized Radius Start" to define the start of the interpolation and the "Non Spatialized Radius Mode" for the mode of the interpolation.
---@field public NonSpatializedRadiusMode ENonSpatializedRadiusSpeakerMapMode @Defines how to interpolate a 3D sound towards a 2D sound when using the non-spatialized radius start and end properties.
