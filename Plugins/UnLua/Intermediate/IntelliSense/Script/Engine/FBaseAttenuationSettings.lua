...
---@field public ConeSphereRadius number @An optional attenuation radius (sphere) that extends from the cone origin.
---@field public ConeSphereFalloffDistance number @The distance over which volume attenuation occurs for the optional sphere shape.
