...
---@field public PktFrameDelay integer @Delays sending packets for a specific number of ticks
---@field public PktIncomingFrameDelay integer @Delays processing received packets for a specific number of ticks
