...
---@field public StrikeBrushHeightPercentage integer @The percentage of the font height to draw the strike brush at. 0% is the bottom, 100% is the top.
---@field public SubFaces TArray<string> @Transient cache of the sub-faces available within this face
---@field public bEnableDistanceFieldRendering boolean @Enables distance field rendering for this face (otherwise only Bitmap rendering is used)
---@field public MinDistanceFieldPpem integer @Single-channel distance field px/em resolution "low" quality value
---@field public MidDistanceFieldPpem integer @Single-channel distance field px/em resolution "medium" quality value
---@field public MaxDistanceFieldPpem integer @Single-channel distance field px/em resolution "high" quality value
---@field public MinMultiDistanceFieldPpem integer @Multi-channel distance field px/em resolution "low" quality value
---@field public MidMultiDistanceFieldPpem integer @Multi-channel distance field px/em resolution "medium" quality value
---@field public MaxMultiDistanceFieldPpem integer @Multi-channel distance field px/em resolution "high" quality value
---@field public PlatformRasterizationModeOverrides Unknown @If set, allows to override distance field modes set in device profiles
local UFontFace = {}
