...
local UObjectElementAssetDataInterface = {}

---Returns the asset data for the given handle, if it exists.
---@param InElementHandle FScriptTypedElementHandle
---@return FAssetData
function UObjectElementAssetDataInterface:GetAssetData(InElementHandle) end
...
function UObjectElementAssetDataInterface:GetAllReferencedAssetDatas(InElementHandle) end
