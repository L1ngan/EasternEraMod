...
---@class FRigUnit_ResolveArrayConnector : FRigUnit_RigModulesBase
...
---@field public Result TArray<FRigElementKey> @* The resulting item the connector is resolved to
---@field public bIsConnected boolean @* Returns true if the connector is resolved to a target.
local FRigUnit_ResolveArrayConnector = {}
