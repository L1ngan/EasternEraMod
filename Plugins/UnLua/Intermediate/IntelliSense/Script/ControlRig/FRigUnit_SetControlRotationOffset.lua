...
---@class FRigUnit_SetControlRotationOffset : FRigUnitMutable
---@field public Control string @The name of the Control to set the transform for.
---@field public Offset FQuat @The input rotation offset to set on the control
...
local FRigUnit_SetControlRotationOffset = {}
