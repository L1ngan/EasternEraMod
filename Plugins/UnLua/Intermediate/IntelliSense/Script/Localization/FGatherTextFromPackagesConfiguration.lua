...
---@field public WorldCollections TArray<string> @* Worlds (including their associated external actors) in these collections may be processed for gathering. The collections may contain more than just worlds, and will be filtered internally. * @@note This is typically not needed unless setting up modular localization targets that have to gather external actors separately from their world (eg, when using External Data Layers).
