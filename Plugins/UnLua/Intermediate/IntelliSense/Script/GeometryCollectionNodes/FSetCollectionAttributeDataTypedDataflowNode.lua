...
---@field public AttributeKey FCollectionAttributeKey @Input to drive the Attribute and Group name
...
---@field public LinearColorAttributeData TArray<FLinearColor> @LinearColor type attribute data
