...
---@field public SelectionChangeSlateSound FSlateSound @The Sound to play when the selection is changed
---@field public ContentPadding FMargin @* Button Content Padding
---@field public MenuRowPadding FMargin @* Menu Row Padding
