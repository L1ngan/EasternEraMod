...
---@field public ShadowOffset FDeprecateSlateVector2D @How much should the shadow be offset for the down arrow? An offset of 0 implies no shadow.
...
---@field public DownArrowPadding FMargin @* Dropdown arrow padding (if a dropdown arrow exists)
---@field public DownArrowAlign integer @* Dropdown arrow vertical alignment
