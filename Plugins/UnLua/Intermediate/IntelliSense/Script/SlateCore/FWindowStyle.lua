...
---@field public EnterFullscreenButtonStyle FButtonStyle @Style used to draw the enter fullscreen button
---@field public ExitFullscreenButtonStyle FButtonStyle @Style used to draw the exit fullscreen button
