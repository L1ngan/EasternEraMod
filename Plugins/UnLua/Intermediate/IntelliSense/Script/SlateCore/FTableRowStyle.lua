...
---@field public bUseParentRowBrush boolean @If using parent row brushes
---@field public ParentRowBackgroundBrush FSlateBrush @Brush used for the top parent row
---@field public ParentRowBackgroundHoveredBrush FSlateBrush @Brush used for the top parent row and row is hovered
