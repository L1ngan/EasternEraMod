---@class UAnimSequencerController : UObject
---@field private Model TWeakObjectPtr<UAnimationSequencerDataModel> @UObject (typed) pointer to Model
---@field private ModelInterface TScriptInterface<UAnimationDataModel>
local UAnimSequencerController = {}

---@param Skeleton USkeleton
---@param SupportedCurveType ERawCurveTrackTypes
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:UpdateCurveNamesFromSkeleton(Skeleton, SupportedCurveType, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetTransformCurveKeys(CurveId, TransformValues, TimeKeys, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetTransformCurveKey(CurveId, Time, Value, bShouldTransact) end

---@param Length number
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:SetPlayLength(Length, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:SetNumberOfFrames(NewLengthInFrames, bShouldTransact) end
...
function UAnimSequencerController:SetModel(InModel) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:SetFrameRate(FrameRate, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveKeys(CurveId, CurveKeys, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveKey(CurveId, Key, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveFlags(CurveId, Flags, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveFlag(CurveId, Flag, bState, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveComment(CurveId, Comment, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetCurveColor(CurveId, Color, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:SetBoneTrackKeys(BoneName, PositionalKeys, RotationalKeys, ScalingKeys, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:ScaleCurve(CurveId, Origin, Factor, bShouldTransact) end

---@param NewLength number
---@param T0 number
---@param T1 number
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:ResizePlayLength(NewLength, T0, T1, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:ResizeNumberOfFrames(NewLengthInFrames, T0, T1, bShouldTransact) end
...
---@param T1 FFrameNumber
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:ResizeInFrames(NewLengthInFrames, T0, T1, bShouldTransact) end

---@param Length number
---@param T0 number
---@param T1 number
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:Resize(Length, T0, T1, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RenameCurve(CurveToRenameId, NewCurveId, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveTransformCurveKey(CurveId, Time, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveCurveKey(CurveId, Time, bShouldTransact) end

---Remove the curve with provided identifier. Broadcasts a EAnimDataModelNotifyType::CurveRemoved notify if successful.
---@param CurveId FAnimationCurveIdentifier
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveCurve(CurveId, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveBoneTrack(BoneName, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveAttributeKey(AttributeIdentifier, Time, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:RemoveAttribute(AttributeIdentifier, bShouldTransact) end
...
---@param SupportedCurveType ERawCurveTrackTypes
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:RemoveAllCurvesOfType(SupportedCurveType, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:RemoveAllBoneTracks(bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return integer
function UAnimSequencerController:RemoveAllAttributesForBone(BoneName, bShouldTransact) end

---Removes all stored attributes. Broadcasts a EAnimDataModelNotifyType::AttributeRemoved notify for each removed attribute.
---@param bShouldTransact boolean @[opt] 
---@return integer
function UAnimSequencerController:RemoveAllAttributes(bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:OpenBracket(InTitle, bShouldTransact) end

---@param BoneName string
---@param DesiredIndex integer
---@param bShouldTransact boolean @[opt] 
---@return integer
function UAnimSequencerController:InsertBoneTrack(BoneName, DesiredIndex, bShouldTransact) end

---
---@return TScriptInterface_UAnimationDataModel_
function UAnimSequencerController:GetModelInterface() end

---@param Skeleton USkeleton
---@param SupportedCurveType ERawCurveTrackTypes
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:FindOrAddCurveNamesOnSkeleton(Skeleton, SupportedCurveType, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:DuplicateCurve(CopyCurveId, NewCurveId, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:DuplicateAttribute(AttributeIdentifier, NewAttributeIdentifier, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
function UAnimSequencerController:CloseBracket(bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:AddCurve(CurveId, CurveFlags, bShouldTransact) end

---@param BoneName string
---@param bShouldTransact boolean @[opt] 
---@return integer
function UAnimSequencerController:AddBoneTrack(BoneName, bShouldTransact) end

---@param BoneName string
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:AddBoneCurve(BoneName, bShouldTransact) end
...
---@param bShouldTransact boolean @[opt] 
---@return boolean
function UAnimSequencerController:AddAttribute(AttributeIdentifier, bShouldTransact) end
