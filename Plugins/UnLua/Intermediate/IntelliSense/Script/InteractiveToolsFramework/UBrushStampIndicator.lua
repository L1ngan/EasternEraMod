...
---@field public bVisible boolean @Controls whether Gizmo will draw visual elements. Does not currently affect AttachedComponent.
---@field public BrushRadius number
---@field public BrushFalloff number
---@field public BrushStrength number
...
---@field public bScaleNormalByStrength boolean
