...
---@field public PhysicsBodyDefinitions TArray<FAnimPhysBodyDefinition>
...
---@field public bDoUpdate boolean @If true we will perform physics update, otherwise skip - allows visualization of the initial state of the bodies
---@field public bDoEval boolean @If true we will perform bone transform evaluation, otherwise skip - allows visualization of the initial anim state compared to the physics sim
...
---@field public bGravityOverrideInSimSpace boolean @If true the gravity override value is defined in simulation space, by default it is in world space
