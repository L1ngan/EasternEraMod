...
---@field public AssetPack_APP_NOT_OWNED integer
---@field public AssetPack_CONFIRMATION_NOT_REQUIRED integer
---@field public AssetPack_UNRECOGNIZED_INSTALLATION integer
