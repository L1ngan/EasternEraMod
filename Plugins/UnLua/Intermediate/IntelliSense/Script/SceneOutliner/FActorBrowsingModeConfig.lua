---@class FActorBrowsingModeConfig
...
---@field public FolderDoubleClickMethod EActorBrowsingFolderDoubleClickMethod @Specifies the behavior of double click on a folder
---@field public bShouldUpdateContentWhileInPIEFocused boolean @True if we want to allow updating content when in PIE with the PIE viewport focused
---@field public bCollapseOutlinerTreeOnNewSelection boolean @True if we want to collapse Outliner tree on new selection, except for the item that was just selected
local FActorBrowsingModeConfig = {}
