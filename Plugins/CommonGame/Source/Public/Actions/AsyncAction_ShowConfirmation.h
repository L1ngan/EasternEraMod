...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta = (BlueprintInternalUseOnly = "true", WorldContext = "InWorldContextObject"))
	static UAsyncAction_ShowConfirmation* ShowConfirmationYesNoLabel(
		UObject* InWorldContextObject, FText Title, FText Message, FText YesLabel, FText NoLabel
	);

	UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta = (BlueprintInternalUseOnly = "true", WorldContext = "InWorldContextObject"))
	static UAsyncAction_ShowConfirmation* ShowConfirmationOkButtonLabel(UObject* InWorldContextObject, FText Title, FText Message, FText OKLabel);
	...
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta = (BlueprintInternalUseOnly = "true", WorldContext = "InWorldContextObject"))
	static UAsyncAction_ShowConfirmation* ShowConfirmationOkCancelButtonLabel(UObject* InWorldContextObject, FText Title, FText Message, FText OKLabel, FText CancelLabel);
