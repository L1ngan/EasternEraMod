...
public:
	...
	static UCommonGameDialogDescriptor* CreateConfirmationOkButtonLabel(const FText& Header, const FText& Body, const FText& OKText);
	static UCommonGameDialogDescriptor* CreateConfirmationOkCancel(const FText& Header, const FText& Body);
	static UCommonGameDialogDescriptor* CreateConfirmationOkCancelButtonLabel(const FText& Header, const FText& Body, const FText& OKText,const FText& CancelText);
	static UCommonGameDialogDescriptor* CreateConfirmationYesNo(const FText& Header, const FText& Body);
	static UCommonGameDialogDescriptor* CreateConfirmationYesNoLabel(const FText& Header, const FText& Body, const FText& YesLabel, const FText& NoLabel);
