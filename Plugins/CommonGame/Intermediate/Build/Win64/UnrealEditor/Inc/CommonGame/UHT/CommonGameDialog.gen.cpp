...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FConfirmationDialogAction;
class UScriptStruct* FConfirmationDialogAction::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConfirmationDialogAction, (UObject*)Z_Construct_UPackage__Script_CommonGame(), TEXT("ConfirmationDialogAction"));
	}
	return Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.InnerSingleton, Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FConfirmationDialogAction.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCommonGameDialogDescriptor;
UClass* UCommonGameDialogDescriptor::GetPrivateStaticClass()
{
	using TClass = UCommonGameDialogDescriptor;
	if (!Z_Registration_Info_UClass_UCommonGameDialogDescriptor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CommonGameDialogDescriptor"),
			Z_Registration_Info_UClass_UCommonGameDialogDescriptor.InnerSingleton,
			StaticRegisterNativesUCommonGameDialogDescriptor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCommonGameDialogDescriptor.InnerSingleton;
}
UClass* Z_Construct_UClass_UCommonGameDialogDescriptor_NoRegister()
{
	return UCommonGameDialogDescriptor::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCommonGameDialog;
UClass* UCommonGameDialog::GetPrivateStaticClass()
{
	using TClass = UCommonGameDialog;
	if (!Z_Registration_Info_UClass_UCommonGameDialog.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CommonGameDialog"),
			Z_Registration_Info_UClass_UCommonGameDialog.InnerSingleton,
			StaticRegisterNativesUCommonGameDialog,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UCommonGameDialog.InnerSingleton;
}
UClass* Z_Construct_UClass_UCommonGameDialog_NoRegister()
{
	return UCommonGameDialog::GetPrivateStaticClass();
}
...
struct Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h__Script_CommonGame_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameDialogDescriptor, UCommonGameDialogDescriptor::StaticClass, TEXT("UCommonGameDialogDescriptor"), &Z_Registration_Info_UClass_UCommonGameDialogDescriptor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameDialogDescriptor), 688315394U) },
