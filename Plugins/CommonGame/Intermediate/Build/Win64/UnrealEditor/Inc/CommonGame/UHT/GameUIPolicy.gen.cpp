...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo;
class UScriptStruct* FRootViewportLayoutInfo::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRootViewportLayoutInfo, (UObject*)Z_Construct_UPackage__Script_CommonGame(), TEXT("RootViewportLayoutInfo"));
	}
	return Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.InnerSingleton, Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameUIPolicy;
UClass* UGameUIPolicy::GetPrivateStaticClass()
{
	using TClass = UGameUIPolicy;
	if (!Z_Registration_Info_UClass_UGameUIPolicy.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("GameUIPolicy"),
			Z_Registration_Info_UClass_UGameUIPolicy.InnerSingleton,
			StaticRegisterNativesUGameUIPolicy,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UGameUIPolicy.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameUIPolicy_NoRegister()
{
	return UGameUIPolicy::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts_Inner = { "RootViewportLayouts", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRootViewportLayoutInfo, METADATA_PARAMS(0, nullptr) }; // 2283106579
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameUIPolicy_Statics::NewProp_RootViewportLayouts = { "RootViewportLayouts", nullptr, (EPropertyFlags)0x0040008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameUIPolicy, RootViewportLayouts), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RootViewportLayouts_MetaData), NewProp_RootViewportLayouts_MetaData) }; // 2283106579
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FRootViewportLayoutInfo::StaticStruct, Z_Construct_UScriptStruct_FRootViewportLayoutInfo_Statics::NewStructOps, TEXT("RootViewportLayoutInfo"), &Z_Registration_Info_UScriptStruct_FRootViewportLayoutInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRootViewportLayoutInfo), 2283106579U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameUIPolicy, UGameUIPolicy::StaticClass, TEXT("UGameUIPolicy"), &Z_Registration_Info_UClass_UGameUIPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameUIPolicy), 3118880866U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_721913790(TEXT("/Script/CommonGame"),
	Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_GameUIPolicy_h__Script_CommonGame_Statics::EnumInfo));
// ********** End Registration *********************************************************************
