...
UFunction* Z_Construct_UDelegateFunction_CommonGame_CreateWidgetAsyncDelegate__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_CommonGame_CreateWidgetAsyncDelegate__DelegateSignature_Statics::FuncParams);
	}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAsyncAction_CreateWidgetAsync;
UClass* UAsyncAction_CreateWidgetAsync::GetPrivateStaticClass()
{
	using TClass = UAsyncAction_CreateWidgetAsync;
	if (!Z_Registration_Info_UClass_UAsyncAction_CreateWidgetAsync.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AsyncAction_CreateWidgetAsync"),
			Z_Registration_Info_UClass_UAsyncAction_CreateWidgetAsync.InnerSingleton,
			StaticRegisterNativesUAsyncAction_CreateWidgetAsync,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAsyncAction_CreateWidgetAsync.InnerSingleton;
}
UClass* Z_Construct_UClass_UAsyncAction_CreateWidgetAsync_NoRegister()
{
	return UAsyncAction_CreateWidgetAsync::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UAsyncAction_CreateWidgetAsync_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncAction_CreateWidgetAsync_CreateWidgetAsync, "CreateWidgetAsync" }, // 2341508251
	};
