...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCommonGameInstance, nullptr, "HandlePrivilegeChanged", Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::CommonGameInstance_eventHandlePrivilegeChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage_Statics::NewProp_MessageType = { "MessageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonGameInstance_eventHandleSystemMessage_Parms, MessageType), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 133831994
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCommonGameInstance;
UClass* UCommonGameInstance::GetPrivateStaticClass()
{
	using TClass = UCommonGameInstance;
	if (!Z_Registration_Info_UClass_UCommonGameInstance.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CommonGameInstance"),
			Z_Registration_Info_UClass_UCommonGameInstance.InnerSingleton,
			StaticRegisterNativesUCommonGameInstance,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCommonGameInstance.InnerSingleton;
}
UClass* Z_Construct_UClass_UCommonGameInstance_NoRegister()
{
	return UCommonGameInstance::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UCommonGameInstance_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged, "HandlePrivilegeChanged" }, // 1672582814
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlerUserInitialized, "HandlerUserInitialized" }, // 1794910357
		{ &Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage, "HandleSystemMessage" }, // 1996599309
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_CommonGameInstance_h__Script_CommonGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameInstance, UCommonGameInstance::StaticClass, TEXT("UCommonGameInstance"), &Z_Registration_Info_UClass_UCommonGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameInstance), 431340068U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_CommonGameInstance_h__Script_CommonGame_1234911760(TEXT("/Script/CommonGame"),
	Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_CommonGameInstance_h__Script_CommonGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_CommonGameInstance_h__Script_CommonGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
