...
FClassRegistrationInfo Z_Registration_Info_UClass_UPrimaryGameLayout;
UClass* UPrimaryGameLayout::GetPrivateStaticClass()
{
	using TClass = UPrimaryGameLayout;
	if (!Z_Registration_Info_UClass_UPrimaryGameLayout.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("PrimaryGameLayout"),
			Z_Registration_Info_UClass_UPrimaryGameLayout.InnerSingleton,
			StaticRegisterNativesUPrimaryGameLayout,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UPrimaryGameLayout.InnerSingleton;
}
UClass* Z_Construct_UClass_UPrimaryGameLayout_NoRegister()
{
	return UPrimaryGameLayout::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UPrimaryGameLayout_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UPrimaryGameLayout_RegisterLayer, "RegisterLayer" }, // 2197448640
	};
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UPrimaryGameLayout_Statics::NewProp_Layers = { "Layers", nullptr, (EPropertyFlags)0x0144008000002008, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPrimaryGameLayout, Layers), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Layers_MetaData), NewProp_Layers_MetaData) }; // 133831994
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h__Script_CommonGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPrimaryGameLayout, UPrimaryGameLayout::StaticClass, TEXT("UPrimaryGameLayout"), &Z_Registration_Info_UClass_UPrimaryGameLayout, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPrimaryGameLayout), 4114952915U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h__Script_CommonGame_1652703177(TEXT("/Script/CommonGame"),
	Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h__Script_CommonGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EasternEraMod_Plugins_CommonGame_Source_Public_PrimaryGameLayout_h__Script_CommonGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
