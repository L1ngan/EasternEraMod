...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMeasuredText;
class UScriptStruct* FMeasuredText::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMeasuredText.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMeasuredText.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeasuredText, (UObject*)Z_Construct_UPackage__Script_CommonGame(), TEXT("MeasuredText"));
	}
	return Z_Registration_Info_UScriptStruct_FMeasuredText.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMeasuredText.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMeasuredText.InnerSingleton, Z_Construct_UScriptStruct_FMeasuredText_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FMeasuredText.InnerSingleton;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCommonPlayerInputKey, nullptr, "IsBoundKeyValid", Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::CommonPlayerInputKey_eventIsBoundKeyValid_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCommonPlayerInputKey, nullptr, "IsHoldKeybind", Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::CommonPlayerInputKey_eventIsHoldKeybind_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCommonPlayerInputKey;
UClass* UCommonPlayerInputKey::GetPrivateStaticClass()
{
	using TClass = UCommonPlayerInputKey;
	if (!Z_Registration_Info_UClass_UCommonPlayerInputKey.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("CommonPlayerInputKey"),
			Z_Registration_Info_UClass_UCommonPlayerInputKey.InnerSingleton,
			StaticRegisterNativesUCommonPlayerInputKey,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCommonPlayerInputKey.InnerSingleton;
}
UClass* Z_Construct_UClass_UCommonPlayerInputKey_NoRegister()
{
	return UCommonPlayerInputKey::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UCommonPlayerInputKey_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_IsBoundKeyValid, "IsBoundKeyValid" }, // 4091761930
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_IsHoldKeybind, "IsHoldKeybind" }, // 2339312809
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetAxisScale, "SetAxisScale" }, // 1590733812
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetBoundAction, "SetBoundAction" }, // 3360071648
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetBoundKey, "SetBoundKey" }, // 4025597100
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetForcedHoldKeybind, "SetForcedHoldKeybind" }, // 1139775842
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetForcedHoldKeybindStatus, "SetForcedHoldKeybindStatus" }, // 3811497687
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetPresetNameOverride, "SetPresetNameOverride" }, // 3998732312
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_SetShowProgressCountDown, "SetShowProgressCountDown" }, // 198301957
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_StartHoldProgress, "StartHoldProgress" }, // 3608608217
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_StopHoldProgress, "StopHoldProgress" }, // 3941306836
		{ &Z_Construct_UFunction_UCommonPlayerInputKey_UpdateKeybindWidget, "UpdateKeybindWidget" }, // 1262577857
	};
...
struct Z_CompiledInDeferFile_FID_ModProject_Plugins_CommonGame_Source_Public_CommonPlayerInputKey_h__Script_CommonGame_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMeasuredText::StaticStruct, Z_Construct_UScriptStruct_FMeasuredText_Statics::NewStructOps, TEXT("MeasuredText"), &Z_Registration_Info_UScriptStruct_FMeasuredText, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeasuredText), 2273136415U) },
	};
