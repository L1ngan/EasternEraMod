...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAsyncAction_CommonUserInitialize, nullptr, "LoginForOnlinePlay", Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::AsyncAction_CommonUserInitialize_eventLoginForOnlinePlay_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAsyncAction_CommonUserInitialize;
UClass* UAsyncAction_CommonUserInitialize::GetPrivateStaticClass()
{
	using TClass = UAsyncAction_CommonUserInitialize;
	if (!Z_Registration_Info_UClass_UAsyncAction_CommonUserInitialize.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AsyncAction_CommonUserInitialize"),
			Z_Registration_Info_UClass_UAsyncAction_CommonUserInitialize.InnerSingleton,
			StaticRegisterNativesUAsyncAction_CommonUserInitialize,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAsyncAction_CommonUserInitialize.InnerSingleton;
}
UClass* Z_Construct_UClass_UAsyncAction_CommonUserInitialize_NoRegister()
{
	return UAsyncAction_CommonUserInitialize::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UAsyncAction_CommonUserInitialize_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_HandleInitializationComplete, "HandleInitializationComplete" }, // 2317253296
		{ &Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_InitializeForLocalPlay, "InitializeForLocalPlay" }, // 3798568840
		{ &Z_Construct_UFunction_UAsyncAction_CommonUserInitialize_LoginForOnlinePlay, "LoginForOnlinePlay" }, // 3477796994
	};
